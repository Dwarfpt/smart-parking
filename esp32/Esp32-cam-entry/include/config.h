// ============================================================
//  Smart Parking — ESP32-CAM (ВЪЕЗД) — Конфигурация
//  HTTP JPEG-сервер для QR-сканирования на въезде
//  IP: 192.168.100.48
// ============================================================
#ifndef CONFIG_H
#define CONFIG_H
...
#define DEVICE_ID        "cam-entry-01"
#define CAM_ROLE         "entry"
...
// ===================== Статический IP (въезд .48) =====================
#define STATIC_IP        192, 168, 100, 48
