// ============================================================
//  Smart Parking — ESP32-CAM (ВЫЕЗД) — main.cpp
//  HTTP JPEG-сервер для QR-сканирования при выезде с парковки
//
//  Эндпоинты:
...
void setup() {
    Serial.begin(115200);
    Serial.println("\n========================================");
    Serial.println("  Smart Parking — Камера ВЫЕЗДА");
    Serial.printf("  ID: %s | IP: 192.168.100.49\n", DEVICE_ID);
    Serial.println("========================================");
