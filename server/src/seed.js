...
const seed = async () => {
  try {
    ...
    // ——— Парковки (Кишинёв) ———
    const lot1 = await ParkingLot.create({ name: 'Smart Parking Макет', nameRo: 'Smart Parking Machetă', nameEn: 'Smart Parking Model', address: 'Макет — ESP32 + камера + шлагбаум', addressRo: 'Machetă — ESP32 + cameră + barieră', addressEn: 'Physical model — ESP32 + camera + barrier', description: 'Физический макет парковки: 4 места, ИК-датчики, камера, шлагбаум', location: { type: 'Point', coordinates: [28.8297, 47.0245] }, totalSpots: 4, workingHours: { open: '00:00', close: '23:59' }, mqttId: 'lot1' });
